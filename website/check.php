...
if(!isset($_GET['password']) || $_GET['password'] != $TFA_SAMP['password']) die("The password is wrong or not valid.");	
...
if(!isset($_GET['userid'])) die("'userid' is missing.");
if(!isset($_GET['token'])) die("'token' is missing.");
